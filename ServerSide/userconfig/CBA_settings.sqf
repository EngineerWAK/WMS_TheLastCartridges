...
force acex_field_rations_timeWithoutFood = 2.4;
force force acex_field_rations_timeWithoutWater = 2.1;
...
force ace_hearing_earplugsVolume = 0.206611;
...
force ace_repair_patchWheelMaximumRepair = 0.2;
