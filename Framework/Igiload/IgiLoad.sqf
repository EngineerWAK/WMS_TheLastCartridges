...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_MARID =  //Can be loaded WITH something else
	[
	...
	[		"R3F_KAMAZ_CE_trans",
		...
		"C_Truck_02_covered_F" //Zamak Civillian  //ARMA3 //Added WAK
	];
	IL_Supported_Vehicles_M1083 =  //Can be loaded WITH something else
	[
		...
		//"rhsusf_M1084A1P2_B_M2_WD_fmtv_usarmy", //too high 80cm
		"rhsusf_M1084A1P2_B_WD_fmtv_usarmy", //OK
		"rhsusf_M1084A1P2_WD_fmtv_usarmy", //OK
		"rhsusf_M1084A1R_SOV_M2_D_fmtv_socom", //test
		"rhsusf_M1084A1R_SOV_M2_WD_fmtv_socom", //test //50cm too high
		//////////
		"rhsusf_M1083A1P2_WD_open_fmtv_usarmy",
		"rhsusf_M1083A1P2_B_WD_open_fmtv_usarmy",
		"rhsusf_M1083A1P2_B_M2_WD_open_fmtv_usarmy"
		//////////
		/*"rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy", //NOPE
		"rhsusf_M1083A1P2_B_d_flatbed_fmtv_usarmy", //NOPE
		"rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy", //NOPE
		"rhsusf_M1083A1P2_d_flatbed_fmtv_usarmy", //NOPE
		"rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy", //NOPE
		"rhsusf_M1083A1P2_B_M2_d_flatbed_fmtv_usarmy" //NOPE*/
	];
	...
	[
		...
		"rhsusf_M977A4_BKIT_usarmy_d" //No M2
	];
	...
	IL_Supported_Vehicles_All = IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_M1083 + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_M977 + IL_Supported_Vehicles_M977M2 + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_VAN+ IL_Supported_Vehicles_MARID + IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_SDV + IL_Supported_Vehicles_UGV + IL_Supported_Vehicles_CHINOOK;
	...
	IL_Supported_M1083 = //Can be loaded on something else
	[
		"rhsusf_M1083A1P2_B_d_fmtv_usarmy",
		"rhsusf_M1083A1P2_B_wd_fmtv_usarmy",
		"rhsusf_M1083A1P2_d_fmtv_usarmy",
	...
	IL_Supported_M977M2 = //Can be loaded on something else
	[ 
		"rhsusf_M977A4_BKIT_M2_usarmy_wd",
		"rhsusf_M977A4_BKIT_M2_usarmy_d",
		"rhsusf_M977A4_BKIT_usarmy_wd", //no M2
	...
	[
		...
		"O_T_LSV_02_unarmed_F",
			...
			"O_T_LSV_02_unarmed_black_F", //unarmed black for exile
			"O_T_LSV_02_unarmed_ghex_F",
			"O_T_LSV_02_unarmed_arid_F",
			"O_LSV_02_unarmed_black_F", //unarmed black for exile
	...
	[
		...
		"rhssaf_m1025_olive_m2", //0.4.2 RHSSAF
		"UK3CB_BAF_LandRover_Soft_Green_A"
	];
	...
	IL_Supported_Box_H2 =  //Can be loaded on something else
	[
		"Box_NATO_AmmoOrd_F",
		"Box_East_AmmoOrd_F",
		"Box_IND_AmmoOrd_F",
	...
	IL_Supported_Cargo20 =  //Can be loaded on something else
	[
		"Land_Cargo20_blue_F",
	...
	IL_Supported_TaruPods =  //Can be loaded on something else
	[
	...
	IL_Supported_Init_All = IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_SDV + IL_Supported_Vehicles_UGV + IL_Supported_Vehicles_VAN + IL_Supported_Vehicles_MARID + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_M1083 + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_M977 + IL_Supported_Vehicles_M977M2 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_MH9 + IL_Supported_MH9 + IL_Supported_Bicycles + IL_Supported_Karts + IL_Supported_HEMTT + IL_Supported_KAMAZ + IL_Supported_M1083 + IL_Supported_TEMPEST + IL_Supported_M977 + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_MARID + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hatchback + IL_Supported_Quadbike + IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20 + IL_Supported_TaruPods;
	...
	IL_Supported_Cargo_Veh_SDV = IL_Supported_Quadbike;
	IL_Supported_Cargo_NonVeh_SDV = IL_Supported_Box_H1 + IL_Supported_Box_H2;
	IL_Supported_Cargo_SDV = IL_Supported_Cargo_NonVeh_SDV;
	
	IL_Supported_Cargo_Veh_UGV = IL_Supported_Quadbike;
	IL_Supported_Cargo_NonVeh_UGV = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2;
	IL_Supported_Cargo_UGV = IL_Supported_Cargo_Veh_UGV + IL_Supported_Cargo_NonVeh_UGV;
	...
	IL_Supported_Cargo_Veh_MARID = IL_Supported_Cargo_Veh_Offroad;
	IL_Supported_Cargo_NonVeh_MARID = IL_Supported_Cargo_NonVeh_Offroad;
	IL_Supported_Cargo_MARID = IL_Supported_Cargo_Veh_MARID + IL_Supported_Cargo_NonVeh_MARID;
	...
	IL_Supported_Cargo_Veh_M1083 = IL_Supported_MH9 + IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV;
	IL_Supported_Cargo_NonVeh_M1083 = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
	IL_Supported_Cargo_M1083 = IL_Supported_Cargo_Veh_M1083 + IL_Supported_Cargo_NonVeh_M1083;
	...
	IL_Supported_Cargo_Veh_M977 = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit;
	IL_Supported_Cargo_NonVeh_M977 = IL_Supported_Cargo_NonVeh_HEMTT;
	IL_Supported_Cargo_M977 = IL_Supported_Cargo_Veh_M977 + IL_Supported_Cargo_NonVeh_M977;
	
	IL_Supported_Cargo_Veh_M977M2 = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit;
	IL_Supported_Cargo_NonVeh_M977M2 = IL_Supported_Cargo_NonVeh_HEMTT;
	IL_Supported_Cargo_M977M2 = IL_Supported_Cargo_Veh_M977M2 + IL_Supported_Cargo_NonVeh_M977M2;

	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_OFFROAD;
	...
	IL_Supported_Cargo_Veh_CHINOOK = IL_Supported_Cargo_Veh_Mohawk + IL_Supported_VAN;
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_SDV) then
		{
			...
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -1.5, true];}; //This one if the cargo is to low or to high WAK
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", -1, true];}; //Position F/B after loading WAK
		};
		if (_obj_type in IL_Supported_Vehicles_UGV) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_UGV, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.75, true];}; //This one if the cargo is to low or to high WAK
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", -1, true];}; //Position F/B after loading WAK
		};
		...
		if (_obj_type in IL_Supported_Vehicles_MARID) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_MARID, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -1.79, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 1, true];};
		};
		...
		if (_obj_type in IL_Supported_Vehicles_M1083) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_KAMAZ, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_M977) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_MH9) then //Attach point as cargo WAK
		{
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Vehicles_MARID) && (_doors == "B")) then
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-4.5,-1.6];
			_box_num = _v getVariable "box_num";
		...
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [+2,-4.5,-1.6]; //[0,-4.5,-1.6]
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		if ((_obj_type in IL_Supported_Vehicles_UGV) && (_doors == "B")) then
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [+2,-4.5,-1.6]; //[0,-4.5,-1.6]
			_box_num = _v getVariable "box_num";
		...
		if ((_obj_type in IL_Supported_Vehicles_M1083) && (_doors == "B")) then
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-6 - (_v getVariable "load_offset"),0];
			_box_num = _v getVariable "box_num";
		...
		{
			{
                ...
                {					
					if (_lock2 <= 1) then
                    {
						...
						if ((_obj_type in IL_Supported_Vehicles_MARID) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-7,_zload], [_x_cargo_offset+0.33, +0.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_OFFROAD) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-4.5,_zload], [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						...
						if ((_obj_type in IL_Supported_Vehicles_SDV) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset+0,-7,-0.25 +_zload], [_x_cargo_offset-0.15,-0.15,_zload], 1, _turn] call IL_Move_Attach; //Second cargo offset is the loading position on the UAV [L/R,F/B,z] z come from setVariable["zload", -1.5, true]
						};
						if ((_obj_type in IL_Supported_Vehicles_UGV) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset+0.45,-4.5,-0.25 +_zload], [_x_cargo_offset+0.45,-1.10,_zload], 1, _turn] call IL_Move_Attach; //+0.45,-4.5,-0.25 +_zload //Second cargo offset is the loading position on the UAV [L/R,F/B,z] z come from setVariable["zload", -0.75, true]
						};
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors == "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_M977M2) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-6.6 - _cargo_offset,_zload], [_x_cargo_offset,_counter - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_CHINOOK)  && (_doors == "B")) then
						{
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_MARID) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset+0.33, +0.25 - _cargo_offset,_zload], [_x_cargo_offset,-7,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_OFFROAD) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], [_x_cargo_offset,-4.5,_zload], 1, _turn] call IL_Move_Attach;
						...
						if ((_obj_type in IL_Supported_Vehicles_SDV) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset-0.05,-0.15,_zload], [_x_cargo_offset+0.45,-7,-0.25 +_zload], 1, _turn] call IL_Move_Attach; // second cargo offset is the distance to unload [L/R,F/B,z] z come from setVariable["zload", -1.5, true]
						};
						if ((_obj_type in IL_Supported_Vehicles_UGV) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset+0.45,-1.150,_zload], [_x_cargo_offset+0.45,-6.5,-0.25 +_zload], 1, _turn] call IL_Move_Attach; // second cargo offset is the distance to unload [L/R,F/B,z] z come from setVariable["zload", -0.75, true]
						};
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors == "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_M1083) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], [_x_cargo_offset,-8 - _cargo_offset,-0.25], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors == "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_M977M2) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,_counter - _cargo_offset,_zload], [_x_cargo_offset,-6.6 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_CHINOOK)  && (_doors == "B")) then
						{
							if !(_para) then
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	if (typeOf _obj_main == "Exile_Chopper_Huron_Green") then
	{
		_obj_main addAction [
...
if (_obj_main_type in IL_Supported_Vehicles_SDV) then
{
	...
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_UGV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_NonVeh_UGV, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	]; //[0,-4.5,0]

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on SDV</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_UGV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_Veh_UGV, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	]; //[0,-4.5,0]
...
if (_obj_main_type in IL_Supported_Vehicles_UGV) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on UGV</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_UGV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_NonVeh_UGV, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on UGV</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_UGV] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_Veh_UGV, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from UGV</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_MARID) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on MARID</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_MARID] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_NonVeh_MARID, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on MARID</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_MARID] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_Veh_MARID, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from MARID</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_M1083) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on M1083</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_M1083] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_M1083, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on M1083</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_M1083] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_M1083, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from M1083</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-6 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_M977) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on M977</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_M977] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_M977, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on M977</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_M977] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_M977, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from M977</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
...
if (_obj_main_type in IL_Supported_Vehicles_M977M2) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on M977M2</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_M977M2] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.6 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_M977M2, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on M977M2</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_M977M2] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.6 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_M977M2, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from M977M2</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-5.7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
	];
	_obj_main addAction [
	"<t color=""#0000ff"">Enable loading from outside</t>",
	{
