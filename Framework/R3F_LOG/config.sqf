 ...
 */
R3F_LOG_CFG_unlock_objects_timer = 3; //30
 ...
 */
R3F_LOG_CFG_string_condition_allow_creation_factory_on_this_client = "getPlayerUID player in [""76561197965501020""]";
...
#include "addons_config\TNA_Logistic.sqf"
