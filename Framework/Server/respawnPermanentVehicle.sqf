...
private ["_playerVHLarray","_spawnSleep","_permanentVhlArray","_playerArray","_targetUID","_vehicleID","_vehicleClassName","_lastPos","_lastPosAGL","_direction","_damage","_weap","_ammo","_backpack","_item","_veh",
...
if !(count _TerritoriesArray == 0) then {
	{
		...
		if (_layout != "flagonly") then {
			_objectsToDespawn=["TREE", "SMALL TREE", "BUSH", "BUILDING", "HOUSE", "FOREST BORDER", "POWER LINES", "FOREST TRIANGLE", "FOREST SQUARE","BUNKER","FOUNTAIN", "FENCE", "WALL", "HIDE", "BUSSTOP", "FOREST", "STACK", "RUIN", "TOURISM", "ROCK", "ROCKS", "RAILWAY"];
...
publicVariable "WMS_tradersMkrPos";
{
	...
	/////NEW/////
	_playerArray = profileNameSpace getVariable [(_x select 0)+"_VHLs", [(_x select 0)]]; //NEW, replace _permanentVhlArray+_playerArrayNumber for the vehicle datas
	/////NEW\\\\\
