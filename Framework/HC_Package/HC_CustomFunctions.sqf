...
WMS_fnc_RemoteTaskPatrol_OLD = {	//it seems like CBA_fnc_taskPatrol do not work on transfered units ? //yep: "if !(local _group) exitWith {}; // Don't create waypoints on each machine" CBA_fnc_taskPatrol line 45
	private ["_Grp"];
	params [
		"_units", //the difference is there
		["_Pos",[worldsize/2,worldsize/2,0]],
...
WMS_fnc_infantryProgram_extraction_OLD = {
	/**
* InfantryProgram
*
* TNA-Community
