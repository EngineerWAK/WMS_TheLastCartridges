...
} forEach ["_statics","_NoWalls","_walls"]; //spawn statics first, walls last
...
_weaponSystemObjects spawn {
	if (true) then {diag_log format ["[TheOneMillionDollarsBase]|WAK|TNA|WMS|_weaponSystemObjects wait to allowDamage _this = %1", _this];};
	uisleep 25;
