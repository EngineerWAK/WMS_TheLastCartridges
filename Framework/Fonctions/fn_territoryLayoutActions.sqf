...
if (WMS_MissionDebug) then {diag_log format ["[INIT_FLAG_ACTIONS]|WAK|TNA|WMS|UPDATE: _this %1", _this]};
	...
	private _territoryOfficeData = getArray(missionConfigFile >> "CfgOfficeTrader" >> "territory");
	private _waterDepth = (_territoryOfficeData select 7);
...
private _layoutsList = [
	...
	['WaterWorld LvL1',			'waterworldlvl1',3000,1,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL1',			'waterworldlvl1',5000,1,'#80c606',true,true,_waterDepth],
	//level 2
	...
	['WaterWorld LvL2',			'waterworldlvl2',5000,2,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL2',			'waterworldlvl2',8000,2,'#80c606',true,true,_waterDepth],
	//level 3
	...
	['WaterWorld LvL3',			'waterworldlvl3',10000,3,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL3',			'waterworldlvl3',15000,3,'#80c606',true,true,_waterDepth],
	//level 4
	...
	['WaterWorld LvL4',			'waterworldlvl4',15000,4,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL4,',		'waterworldlvl4',20000,4,'#80c606',true,true,_waterDepth],
	['ALAMO 45x45 LvL4',		'AlamoLVL4',15000,4,'#80c606',false,false],
	['ALAMO 45x45 LvL4',		'AlamoLVL4',20000,4,'#80c606',true,false],
	//level 5
	...
	['WaterWorld LvL5',			'waterworldlvl5',20000,5,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL5',			'waterworldlvl5',25000,5,'#80c606',true,true,_waterDepth],
	//level 6
	...
	['WaterWorld LvL6',			'waterworldlvl6',30000,6,'#80c606',false,true,_waterDepth],
	['WaterWorld LvL6',			'waterworldlvl6',35000,6,'#80c606',true,true,_waterDepth],
	['ALAMO 74x74 LvL6',		'alamolvl6',43000,6,'#80c606',false,false],
	['ALAMO 74x74 LvL6',		'alamolvl6',48000,6,'#80c606',true,false],
	//level 6 ARMED
...
////////////////////////////////////////////////////////////////////////////
{
	...
	if (_x select 6) then { //surface is water
		_conditions = format ["
			...
			{((atltoasl position _target) select 2 < %4)} &&
			...
			{(vehicle _this == _this)};
			",
			((_x select 3)-1),((_x select 3)+1),(_x select 2),(_x select 7)
		];
	}else { //surface is not water
		_conditions = format ["
			(alive _target) &&
			{!(surfaceIsWater (position _target))} &&
			{((atltoasl position _target) select 2 > -1)} &&
			{(_target getVariable ['_layoutUpgradable', true])} &&
			{((_target getVariable ['exileterritorylevel', -1]) > %1)} &&
			{((_target getVariable ['exileterritorylevel', -1]) < %2)} &&
			{((_target getVariable ['WMS_BuyerOwner', -1]) == (getPlayerUID _this))} &&
