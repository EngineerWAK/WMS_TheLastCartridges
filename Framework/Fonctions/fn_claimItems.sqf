...
if (_type == "banana")then { //this will change later
	_rewardObjects = [ //Viper Loadout
		...
		"arifle_ARX_ghex_F","muzzle_snds_65_TI_ghex_F","acc_pointer_IR","optic_Nightstalker","30Rnd_65x39_caseless_green","10Rnd_50BW_Mag_F",
		...
		"ACE_fieldDressing","ACE_morphine","ACE_splint","ACE_tourniquet","ACE_plasmaIV_250"
		];
	{
	...
	_caller setVariable ["WMS_lastKill",servertime+600,true];
	};
