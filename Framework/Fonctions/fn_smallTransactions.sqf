 ...
 */
//[_caller, _price] remoteExec ['WMS_fnc_smallTransactions'];
...
if (true) then {diag_log format ["[SMALL_TRANSACTION]|WAK|TNA|WMS| _this %1", _this]};
...
if (true) then {diag_log format ["[SMALL_TRANSACTION]|WAK|TNA|WMS| _playerMoney %1- _price %2= _newMoney", _playerMoney, _price, _newMoney]};